    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="sobre" className="bg-muted py-20">
        <div className="container text-center max-w-5xl mb-14">
          ...
          <p className="text-lg text-muted-foreground font-bold" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>Un programa diseñado para edades 2 a 4 años, donde cada niño descubre su mejor versión rodeado de amor y aprendizaje significativo.</p>
        </div>
